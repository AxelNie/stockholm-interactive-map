...
//   const latStep = stepSize.lat * 3;
//   const lngStep = stepSize.lng * 3;

//   for (let i = 0; i < travelTimes.length; i++) {
//     if (processedIndices.has(i)) continue;

//     if (priceIndex >= apartmentPrices.length) {
//       result.push({ ...travelTimes[i] });
//       continue;
//     }

//     const currentTravelTime = travelTimes[i];
//     const currentApartmentPrice = apartmentPrices[priceIndex];

//     if (
//       isWithinPriceCell(
//         currentTravelTime,
//         currentApartmentPrice,
//         latStep,
//         lngStep
//       )
//     ) {
//       result.push({
//         ...currentTravelTime,
//         averagePrice: currentApartmentPrice.averagePrice,
//       });
//       added++;
//       processedIndices.add(i);

//       // Check and add neighbors
//       const neighbors = getNeighbors(i, gridDimensions);
//       neighbors.forEach((neighborIndex) => {
//         if (
//           neighborIndex >= 0 &&
//           neighborIndex < travelTimes.length &&
//           !processedIndices.has(neighborIndex) &&
//           isWithinPriceCell(
//             travelTimes[neighborIndex],
//             currentApartmentPrice,
//             latStep,
...
//           });
//           added++;
//           processedIndices.add(neighborIndex);
//         }
//       });

//       // Adjust priceIndex if no neighbors are in the same cell
//       const areNeighborsInSameCell = neighbors.some(
//         (index) =>
//           index >= 0 &&
...
//       if (!areNeighborsInSameCell) {
//         priceIndex++;
//       }
//     } else {
//       // Check if we need to move to the next apartment price cell
//       if (
//         shouldMoveToNextPriceCell(
//           currentTravelTime,
//           currentApartmentPrice,
//           latStep,
//           lngStep
...
//         priceIndex++;
//         if (priceIndex < apartmentPrices.length) {
//           i--; // Re-evaluate the same travel time with the next apartment price cell
//         }
//       }
//     }
//   }
...
// function shouldMoveToNextPriceCell(
//   travelTime: ILocation,
//   priceCell: ILocation,
//   latStep: number,
//   lngStep: number
